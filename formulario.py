...
# se crea el metodo incluir lista
    def incluir_lista(self):
        numero3=input( "ingresa un numero: ")# se pide un tercer numero
        numero4=input("ingrese otro numero: ")# y un cuarto numero
...
# se crea el metodo insertar dato
    def insertar_dato(self):
        valor1 = input("Ingrese un numero: ")# se le pide un numero a el usuario  para añadirlo a la lista
        valor2 = input("Ingresa otro numero: ")
    ...
    def eliminar_dato(self):
        posicion = input(" ingrese la posicion del numero que deseas eliminar ")# se pide el numero a eliminar 
